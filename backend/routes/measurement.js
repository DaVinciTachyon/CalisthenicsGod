  ...
  .get(async (req, res) => {
    ...
    if (measurements.weight.length > 0)
      res.send({
        ...
        height:
          measurements.height.length > 0 ? measurements.height[0].value : 0,
        ...
        rightBicep:
          measurements.rightBicep.length > 0
            ...
            : 0,
        leftBicep:
          measurements.leftBicep.length > 0
            ? measurements.leftBicep[0].value
            : 0,
        rightForearm:
        ...
        leftForearm:
          measurements.rightForearm.length > 0
            ...
            : 0,
        shoulders:
          measurements.shoulders.length > 0
            ? measurements.shoulders[0].value
            : 0,
